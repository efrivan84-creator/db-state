...
Current release line: `0.1.3`. The API is intentionally small and still pre-1.0, so breaking changes remain possible before `1.0`. See [CHANGELOG.md](CHANGELOG.md) for release notes and current limitations.
