...
Текущая версия: `0.1.3`. API намеренно маленький и всё ещё pre-1.0, поэтому до `1.0` возможны ломающие изменения. Изменения и актуальные ограничения вынесены в [CHANGELOG.ru.md](CHANGELOG.ru.md).
