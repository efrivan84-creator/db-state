...
Миллионы записей нормальны при индексе `{ createdAt: 1, _id: 1 }`. Для очень высокого write volume нужны retention, snapshots или continuation cursor по `{ createdAt, _id }`.
