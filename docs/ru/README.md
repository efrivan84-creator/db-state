...
- [Права доступа](server/permissions.md) - `_permission`, `if`, field-level read/write.
- [Code access rules](server/code-access-rules.md) - JS-правила доступа, owner checks, lazy `loadDoc`.
